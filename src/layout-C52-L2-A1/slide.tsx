...
import SlideData from "@/src/layout-C52-L2-A1/pointers.json";
import Slide2Data from "@/src/layout-C52-L2-A1/pointers2.json";
...
useEffect(() => {
  if (visibleCount2 === Slide2Data.length * 2) {
    setOpen(true);
  }
}, [visibleCount2]);
      ...
      <div className="w-[90%] flex justify-center items-center flex-col gap-3">
        <div className="w-full shadow-md p-5 min-h-[200px]">
          ...
          >
            <SwiperSlide>
              <div className="grid grid-cols-12 w-full place-items-center p-2">
                <div className="col-span-12 w-full flex flex-col  justify-center items-center gap-2">
                  <ul className="list-disc w-[40%] px-5 space-y-2">
            ...
            <SwiperSlide>
              <div className="grid grid-cols-12 w-full place-items-center p-2">
                <div className="col-span-12 w-full flex justify-center items-center gap-5">
                  <iframe
                    width="600"
                    height="400"
                    src="https://www.youtube.com/embed/HpJGncHYZkE?si=OudPi2M-m9ZuXSnk"
            ...
            <SwiperSlide>
              <div className="grid grid-cols-12 w-full place-items-center p-2">
                <div className="col-span-12 w-full flex justify-center items-center gap-5">
                  <MyImage path="/C52Images/Bookcover.jpg" />
                </div>
