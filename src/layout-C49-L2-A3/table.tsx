...
import tableData from "@/src/layout-C49-L2-A3/tableData.json";
...
<div className="col-span-12 w-full text-center font-bold py-3 text-black">Ragi Flour  vs All-Purpose Flour</div>
        {/* RAGI IMAGE */}
        <div className="col-span-4 border"></div>
        <div className="col-span-4 flex flex-col justify-center items-center border">
          <div className="w-20 h-20 relative">
            <Image src="/C49Images/Ragi.jpeg" fill alt="ragi" />
          </div>
            <h4 className="text-black ">RAGI</h4>
        </div>

        {/* ALL-PURPOSE IMAGE */}
         <div className="col-span-4 flex flex-col justify-center items-center border">
          <div className="w-20 h-20 relative">
            <Image src="/C49Images/APF.jpg" fill alt="ragi" />
          </div>
            <h4 className="text-black ">ALL-PURPOSE</h4>
        </div>
        {/* OUTCOMES */}
        ...
        <div
          ...
          onDrop={(e) => handleDrop(e, "RAGI-Outcomes")}
        >
          {(dropItems["RAGI-Outcomes"] || []).map((t, i) => (
        ...
        <div
          ...
          onDragOver={(e) => e.preventDefault()}
          onDrop={(e) => handleDrop(e, "ALL-PURPOSE-Outcomes")}
        >
          {(dropItems["ALL-PURPOSE-Outcomes"] || []).map((t, i) => (
            <p key={i} className="border text-black text-center  p-1">{t}</p>
          ))}
        </div>
        ...
        <div
          className="col-span-4  border p-2"
          onDragOver={(e) => e.preventDefault()}
          onDrop={(e) => handleDrop(e, "RAGI-Reasons")}
        >
          {(dropItems["RAGI-Reasons"] || []).map((t, i) => (
            <p key={i} className="border text-black text-center  p-1">{t}</p>
          ))}
        </div>
        ...
        <div
          className="col-span-4  border p-2"
          onDragOver={(e) => e.preventDefault()}
          onDrop={(e) => handleDrop(e, "ALL-PURPOSE-Reasons")}
        >
          {(dropItems["ALL-PURPOSE-Reasons"] || []).map((t, i) => (
        ...
        <div
          className="col-span-4  border p-2"
          onDragOver={(e) => e.preventDefault()}
          onDrop={(e) => handleDrop(e, "RAGI-Impact")}
        >
          {(dropItems["RAGI-Impact"] || []).map((t, i) => (
            <p key={i} className="border text-center text-black  p-1">{t}</p>
          ))}
        </div>
        ...
        <div
          className="col-span-4  border p-2"
          onDragOver={(e) => e.preventDefault()}
          onDrop={(e) => handleDrop(e, "ALL-PURPOSE-Impact")}
        >
          {(dropItems["ALL-PURPOSE-Impact"] || []).map((t, i) => (
            <p key={i} className="border text-center text-black  p-1">{t}</p>
          ))}
        </div>
