...
import tableData from "@/src/layout-C49-L2-A3/tableData2.json";
...
<div className="col-span-12 w-full text-center font-bold py-3 text-black">Sugar-Free Cookies Vs. Cookies With Sugar</div>
        {/* RAGI IMAGE */}
        <div className="col-span-4 border"></div>
        <div className="col-span-4 flex flex-col justify-center items-center border">
          <div className="w-20 h-20 relative">
            <Image src="/C49Images/SFC.jpg" fill alt="Light Sugar" />
          </div>
            <h4 className="text-black ">Light Sugar</h4>
        </div>

        {/* ALL-PURPOSE IMAGE */}
         <div className="col-span-4 flex flex-col justify-center items-center border">
          <div className="w-20 h-20 relative">
            <Image src="/C49Images/Cookies_Sugar.jpg" fill alt="High SUGAR" />
          </div>
            <h4 className="text-black ">High SUGAR</h4>
        </div>
        {/* OUTCOMES */}
        ...
        <div
          ...
          onDrop={(e) => handleDrop(e, "Light-Sugar-Outcomes")}
        >
          {(dropItems["Light-Sugar-Outcomes"] || []).map((t, i) => (
        ...
        <div
          ...
          onDragOver={(e) => e.preventDefault()}
          onDrop={(e) => handleDrop(e, "High-SUGAR-Outcomes")}
        >
          {(dropItems["High-SUGAR-Outcomes"] || []).map((t, i) => (
            <p key={i} className="border text-black text-center  p-1">{t}</p>
          ))}
        </div>
        ...
        <div
          className="col-span-4  border p-2"
          onDragOver={(e) => e.preventDefault()}
          onDrop={(e) => handleDrop(e, "Light-Sugar-Reasons")}
        >
          {(dropItems["Light-Sugar-Reasons"] || []).map((t, i) => (
            <p key={i} className="border text-black text-center  p-1">{t}</p>
          ))}
        </div>
        ...
        <div
          className="col-span-4  border p-2"
          onDragOver={(e) => e.preventDefault()}
          onDrop={(e) => handleDrop(e, "High-SUGAR-Reasons")}
        >
          {(dropItems["High-SUGAR-Reasons"] || []).map((t, i) => (
        ...
        <div
          className="col-span-4  border p-2"
          onDragOver={(e) => e.preventDefault()}
          onDrop={(e) => handleDrop(e, "Light-Sugar-Impact")}
        >
          {(dropItems["Light-Sugar-Impact"] || []).map((t, i) => (
            <p key={i} className="border text-center text-black  p-1">{t}</p>
          ))}
        </div>
        ...
        <div
          className="col-span-4  border p-2"
          onDragOver={(e) => e.preventDefault()}
          onDrop={(e) => handleDrop(e, "High-SUGAR-Impact")}
        >
          {(dropItems["High-SUGAR-Impact"] || []).map((t, i) => (
            <p key={i} className="border text-center text-black  p-1">{t}</p>
          ))}
        </div>
