...
import tableData from "@/src/layout-C49-L2-A3/tableData3.json";
...
<div className="col-span-12 w-full text-center font-bold py-3 text-black">Water vs. Carbonated Soda</div>
        {/* RAGI IMAGE */}
        <div className="col-span-4 border"></div>
        <div className="col-span-4 flex flex-col justify-center items-center border">
          <div className="w-20 h-20 relative">
            <Image src="/C49Images/water.jpg" fill alt="WATER" />
          </div>
        ...
        {/* ALL-PURPOSE IMAGE */}
         <div className="col-span-4 flex flex-col justify-center items-center border">
          <div className="w-20 h-20 relative">
            <Image src="/C49Images/Carbonated.jpg" fill alt="SODA" />
          </div>
            <h4 className="text-black ">SODA</h4>
        </div>
        {/* OUTCOMES */}
        ...
        <div
          ...
          onDragOver={(e) => e.preventDefault()}
          onDrop={(e) => handleDrop(e, "SODA-Outcomes")}
        >
          {(dropItems["SODA-Outcomes"] || []).map((t, i) => (
            <p key={i} className="border text-black text-center  p-1">{t}</p>
          ))}
        </div>
        ...
        <div
          className="col-span-4  border p-2"
          onDragOver={(e) => e.preventDefault()}
          onDrop={(e) => handleDrop(e, "SODA-Reasons")}
        >
          {(dropItems["SODA-Reasons"] || []).map((t, i) => (
        ...
        <div
          className="col-span-4  border p-2"
          onDragOver={(e) => e.preventDefault()}
          onDrop={(e) => handleDrop(e, "WATER-Impact")}
        >
          {(dropItems["WATER-Impact"] || []).map((t, i) => (
            <p key={i} className="border text-center text-black  p-1">{t}</p>
          ))}
        </div>
        ...
        <div
          className="col-span-4  border p-2"
          onDragOver={(e) => e.preventDefault()}
          onDrop={(e) => handleDrop(e, "SODA-Impact")}
        >
          {(dropItems["SODA-Impact"] || []).map((t, i) => (
            <p key={i} className="border text-center text-black  p-1">{t}</p>
          ))}
        </div>
