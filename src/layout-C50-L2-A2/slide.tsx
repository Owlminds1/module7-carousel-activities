          ...
          >
                  ...
                  {SlideData.map((item, index) => {
                    ...
                    return (
                      <div key={index} className="mt-5 w-full">
                        {/* Question */}
                        {showQuestion && (
                          <h4 className="text-xl  font-medium text-left w-full  text-black">
                            {item.question}
                          </h4>
                        )}
                        ...
                        {/* Answer */}
                        {showAnswer && (
                          <p className="text-black text-lg  mt-1">{item.answer}</p>
                        )}
                      </div>
                    );
                  })}
            ...
            <SwiperSlide>
              <div className="flex justify-center items-center p-2">
                ...
                <div className="  w-[60%] bg flex justify-center items-center flex-col  ">
