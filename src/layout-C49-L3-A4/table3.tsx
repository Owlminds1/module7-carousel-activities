...
<div className="col-span-12 w-full text-center font-bold py-3 text-black">Savings vs. Spending</div>
        {/* RAGI IMAGE */}
        ...
        <div
          ...
          onDrop={(e) => handleDrop(e, "Savings-Outcomes")}
        >
          {(dropItems["Savings-Outcomes"] || []).map((t, i) => (
        ...
        <div
          ...
          onDragOver={(e) => e.preventDefault()}
          onDrop={(e) => handleDrop(e, "Spending-Outcomes")}
        >
          {(dropItems["Spending-Outcomes"] || []).map((t, i) => (
            <p key={i} className="border text-black text-center  p-1">{t}</p>
          ))}
        </div>
        ...
        <div
          className="col-span-4  border p-2"
          onDragOver={(e) => e.preventDefault()}
          onDrop={(e) => handleDrop(e, "Savings-Reasons")}
        >
          {(dropItems["Savings-Reasons"] || []).map((t, i) => (
            <p key={i} className="border text-black text-center  p-1">{t}</p>
          ))}
        </div>
        ...
        <div
          className="col-span-4  border p-2"
          onDragOver={(e) => e.preventDefault()}
          onDrop={(e) => handleDrop(e, "Spending-Reasons")}
        >
          {(dropItems["Spending-Reasons"] || []).map((t, i) => (
        ...
        <div
          className="col-span-4  border p-2"
          onDragOver={(e) => e.preventDefault()}
          onDrop={(e) => handleDrop(e, "Savings-Impact")}
        >
          {(dropItems["Savings-Impact"] || []).map((t, i) => (
            <p key={i} className="border text-center text-black  p-1">{t}</p>
          ))}
        </div>
        ...
        <div
          className="col-span-4  border p-2"
          onDragOver={(e) => e.preventDefault()}
          onDrop={(e) => handleDrop(e, "Spending-Impact")}
        >
          {(dropItems["Spending-Impact"] || []).map((t, i) => (
            <p key={i} className="border text-center text-black  p-1">{t}</p>
          ))}
        </div>
