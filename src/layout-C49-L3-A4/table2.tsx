...
<div className="col-span-12 w-full text-center font-bold py-3 text-black">Service vs. Profit</div>
        {/* RAGI IMAGE */}
        ...
        <div
          ...
          onDrop={(e) => handleDrop(e, "Service-Outcomes")}
        >
          {(dropItems["Service-Outcomes"] || []).map((t, i) => (
        ...
        <div
          ...
          onDragOver={(e) => e.preventDefault()}
          onDrop={(e) => handleDrop(e, "Profit-Outcomes")}
        >
          {(dropItems["Profit-Outcomes"] || []).map((t, i) => (
            <p key={i} className="border text-black text-center  p-1">{t}</p>
          ))}
        </div>
        ...
        <div
          className="col-span-4  border p-2"
          onDragOver={(e) => e.preventDefault()}
          onDrop={(e) => handleDrop(e, "Service-Reasons")}
        >
          {(dropItems["Service-Reasons"] || []).map((t, i) => (
            <p key={i} className="border text-black text-center  p-1">{t}</p>
          ))}
        </div>
        ...
        <div
          className="col-span-4  border p-2"
          onDragOver={(e) => e.preventDefault()}
          onDrop={(e) => handleDrop(e, "Profit-Reasons")}
        >
          {(dropItems["Profit-Reasons"] || []).map((t, i) => (
        ...
        <div
          className="col-span-4  border p-2"
          onDragOver={(e) => e.preventDefault()}
          onDrop={(e) => handleDrop(e, "Service-Impact")}
        >
          {(dropItems["Service-Impact"] || []).map((t, i) => (
            <p key={i} className="border text-center text-black  p-1">{t}</p>
          ))}
        </div>
        ...
        <div
          className="col-span-4  border p-2"
          onDragOver={(e) => e.preventDefault()}
          onDrop={(e) => handleDrop(e, "Profit-Impact")}
        >
          {(dropItems["Profit-Impact"] || []).map((t, i) => (
            <p key={i} className="border text-center text-black  p-1">{t}</p>
          ))}
        </div>
