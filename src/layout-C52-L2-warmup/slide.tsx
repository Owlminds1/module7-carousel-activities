...
import SlideData from "@/src/layout-C52-L2-warmup/slide1.json";
                    ...
                    </h2>
{
  show ? 
                    ...
                    : <button onClick={()=>setShow(true)} className="text-white bg-violet-900 px-5 py-2 cursor-pointer">Show Suggestion</button>
}
                </div>
              </div>
            </SwiperSlide>
